module github.com/skip-mev/fast-transfer-solver/e2e
...
require (
	...
	github.com/skip-mev/fast-transfer-solver v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/skip-mev/fast-transfer-solver => ../..
